    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GridView.count(
          ...
          children: [
            _buildStatCard('Admins', '$totalAdmins Admins Registered',
                Colors.red, Icons.admin_panel_settings),
            _buildStatCard('Users', '$totalUsers Users Registered',
                Colors.green, Icons.person),
            _buildStatCard('Total Complexes',
                '$totalEvents Complexes Registered', Colors.blue, Icons.event),
            _buildStatCard(
                'Active Bookings',
